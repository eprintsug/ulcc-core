...
sub get_basic_input_elements
{
	...
	my $ex = $self->SUPER::get_basic_input_elements( $session, $value, $basename, $staff, $object, $prefix, $row_no );
...
{   
	...
	my $input = $self->SUPER::get_input_elements( $session, $value, $staff, $obj, $basename, $prefix );
